                    ...
                    privilege.buttonType === "" ? null :
                        privilege.buttonType === "DIALOG" ?
                            ...
                            privilege.buttonType === "LINK" ?
                                (<Link href={tc(privilege.buttonLink)} className="tw-mt-5 tw-py-[4px] tw-px-4 tw-border-[1px] tw-border-solid tw-border-white tw-text-white hover:tw-text-black hover:tw-bg-white tw-rounded-[100px] tw-transition tw-ease-in tw-delay-150 duration-150 tw-block tw-w-fit hover:tw-no-underline">{tc(privilege.buttonText)}</Link>)
                                : null
                }                </div>
            </div>
        </>
